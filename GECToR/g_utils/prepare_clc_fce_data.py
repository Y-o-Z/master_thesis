...
Cambridge Learner Corpus - First Certificate English
"""

import argparse
# -> return files matching some pattern
import glob
import os
import re
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Convert CLC-FCE dataset to the parallel sentences format.")
    parser.add_argument('--output', help='Path to the output folder')
    parser.add_argument('fce_dataset_path', help='Path to the folder with the FCE dataset')
